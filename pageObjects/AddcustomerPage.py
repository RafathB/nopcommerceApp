...
class AddCustomer:
    ...
    rdMaleGender_id = "Gender_Male"  # change
    rdFeMaleGender_id = "Gender_Female"
    txtDob_xpath = "//input[@id='DateOfBirth']"
    txtCompanyName_xpath = "//input[@id='Company']"
    txtcustomerRoles_xpath = "//body[1]/div[3]/div[1]/form[1]/section[1]/div[1]/div[1]/nop-cards[1]/nop-card[1]/div[1]/div[2]/div[10]/div[2]/div[1]/div[1]/div[1]"
    ...
    def __init__(self, driver): #Constructor for initiating chrome
        self.driver = driver

    def clickOnCustomersMenu(self): #call methods inside the class
